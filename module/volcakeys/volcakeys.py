...
control_name = ['portamento', 'expression', 'voice', 'octave', 'detune', 'vco_eg_int', 'cutoff', 'vcf_eg_int', 'lfo_rate', 'lfo_pitch_int', 'lfo_cutoff_int', 'eg_attack', 'eg_decay_release', 'eg_sustain', 'delay_time', 'delay_feedback']
